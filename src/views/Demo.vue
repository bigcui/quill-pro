        ...
        addSelectAttr() {
            ...
            class SelectBlot extends BlockEmbed {
                static create(value) {
                    ...
                    let createPanel = (list) => {
                        ...
                        for (let i = 0; i < len.length; i++) {
                            ...
                            if (value.value && selectVavList.length) {
                                activedCode = value.value.split('/')[levelIndex - 1];
                                ul.children.forEach(el => {
                                    if (el.getAttribute('code') === activedCode) {
                                        el.classList.add('in-active-path');
                    ...
                    node.setAttribute('max-width', '100%');
                    node.setAttribute('max-width', '100%');
                    this.popperJS = new Popper(selectDiv, selectWraperALL, {});
                    this.popperJS.onCreate(_ => {
                        // this.$emit('created', this);
                        // this.resetTransformOrigin();
                        console.log(_,1111, this.popperJS)
                        this.popperJS.update();
